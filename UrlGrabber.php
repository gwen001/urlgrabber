...
class UrlGrabber
{
	...
	const T_ASSETS_EXTENSIONS = ['js','css','woff','woff2','eot','ttf','pdf','svg','png','ico','gif','jpg','jpeg','bmp','txt','csv','pdf','xml','mp3','mp4','mpg','mpeg','avi','mov','wmv','doc','xls','zip','tar','7z','rar','tgz','gz' ];
